...
if up == "0":
         print ('(Super) Code filter =>' + '%s%s  (4.q.q/q/w/w/v/v/u//999/1.1.7.7.7/jiji/y//4.2.2.1.2.2/22.1/ww//9.9.ee.8) %s' % (fg('red'), bg('black'), attr('reset')))
...
if up != "5":
        ...
        print('report/aout/report//aout/acc//acc/wwww/activ/activkkk//vvv//vv')


if up == "2":
        print ('code group ≠>' + '%s%s (9.9.9.2/kjkj/rerr/0.8.9.9.9.8/ilio/8.2.2.2/www//0.0.00.3.3/33.3/ioio/9) %s' % (fg('white'), bg('black'), attr('reset')))
...
if up == "3":
        ...
        print ('code Filter account ≠>' + '%s%s (8.8.2.5.6//xz/1.4.4.4/gs/ii/ii/6.6.6.6.2/vi//v/8.8.k/jjj.2.3.4.4/ppok//rwrw/p/pp/3/yyy/yoo/o/1/ww//ww/11) %s' % (fg('red'), bg('blue'), attr('reset')))
