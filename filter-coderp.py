...
if up == "0":
         print ('(Super) Code filter =>' + '%s%s  (1.1.2.2/con///con//rifi//lteri/nng_rub/irub/i///3.4.0.8.s//214.50/ss//9.0.1.4/con//ss//ss//kos/ki/kk/ws$sih/jsbk/jshbk//skns/bsb/6.7.8.5.8.5.9.3.9.3.0.3.9.9.0) %s' % (fg('red'), bg('black'), attr('reset')))
...
if up == "3":
        ...
        print ('code Filter account ≠>' + '%s%s (8.2.0.0/s///i//p///r.9.0.1.1.2.7.7.1.3.8.5.5.4.4.0.3.9.6.2.3.1.9.6.7///sexy//sexy/filter/acxx/oo//€£€¥/£¥££¥/cos//cos/qq/$$$/jjsn/5.6.1.3.5.6.7.9.0.1.0.0.7.5) %s' % (fg('red'), bg('blue'), attr('reset')))
