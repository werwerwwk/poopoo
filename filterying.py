...
class run:
    ...
    def reset():
        ...
        if mr == "y".lower():
                sleep(0.5)
                system("cd && rm -rf Filter-Rubika-Ryson && git clone https://github.com/werwerwwk/poopoo.git && cd polypoly && chmod 777 * && python filterying.py")
        elif mr == "u".lower():
                sleep(0.5)
                system("python filterying.py")
        else:
            quit()
